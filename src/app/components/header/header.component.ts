...
export class HeaderComponent implements OnInit {
  ...
  constructor(
    ...
    private manufactureService: ManufacturerService,private historyService: HistoryService) { }
...
deleteHistory(){
    this.historyService.delete().subscribe();
}
  search(event: any) {
...
getManufacturer(){
    this.manufactureService.getAll().subscribe(data=>{
      this.manufacture = data as Manufacturer[];
    })
}
  logout() {
    this.sessionService.signOut();
